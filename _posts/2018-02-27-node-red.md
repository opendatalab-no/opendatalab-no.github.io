...
Please find below the code used in the video to set up the headers of the request used to gather your S.Banken access token. Please note that "…==" should be replaced a base 64 code to be generated from  your **user.id** and **secret**. This can be done using this tool for instance: https://www.blitter.se/utils/basic-authentication-header-generator/
...
{% include video id="m6gdU4i9BqQ" provider="youtube" %}
